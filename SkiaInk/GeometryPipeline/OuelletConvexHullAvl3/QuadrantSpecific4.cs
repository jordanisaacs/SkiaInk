...
namespace SkiaInk.GeometryPipeline.OuelletConvexHullAvl3
{
	public class QuadrantSpecific4 : Quadrant
	{
		...
		// ************************************************************************
		public QuadrantSpecific4(ConvexHull convexHull, IReadOnlyList<PolygonPoint> listOfPoint) : base(convexHull, listOfPoint, new Q4Comparer())
		{
			Name = QuadrantName;
		}
		...
		protected override void SetQuadrantLimits()
		{
			...
			RootPoint = new SKPoint(FirstPoint.Pos.X, LastPoint.Pos.Y);
		}
